...
public class FileFormatUtils {
  ...
  /**
   * Retrieve {@link cz.o2.proxima.direct.io.bulkfs.NamingConvention} from configuration.
   *
  ...
  /**
   * Get {@link cz.o2.proxima.direct.io.bulkfs.FileFormat} from configuration.
   *
   * @param cfgPrefix prefix to add to default config settings
   * @param cfg the configuration
   * @return {@link cz.o2.proxima.direct.io.bulkfs.FileFormat}
   */
  ...
  static FileFormat getFileFormatFromName(String format, boolean gzip) {
    ...
    if ("parquet".equals(format)) {
      ...
      format = "cz.o2.proxima.direct.io.bulkfs.parquet.ParquetFileFormat";
    }
    try {
