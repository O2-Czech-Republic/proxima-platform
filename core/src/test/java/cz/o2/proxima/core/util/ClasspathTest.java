...
public class ClasspathTest {
  ...
  public void testFindTopLevelClassWithValidSuperClass() {
    assertEquals(
        DummyFilter.class,
        Classpath.findClass("cz.o2.proxima.core.util.DummyFilter", PassthroughFilter.class));
  }
  ...
  public void testCreateNewInstanceForTopLevelClassWithValidSuper() {
    assertEquals(
        DummyFilter.class,
        Classpath.newInstance("cz.o2.proxima.core.util.DummyFilter", PassthroughFilter.class)
            .getClass());
  }
