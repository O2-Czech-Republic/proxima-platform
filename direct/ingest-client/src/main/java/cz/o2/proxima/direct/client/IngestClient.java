...
public class IngestClient implements AutoCloseable {
  ...
  /**
   * Sends synchronously {@link cz.o2.proxima.direct.server.rpc.proto.service.Rpc.GetRequest} to
   * retrieve data from the system.
   *
   * @param request Instance of {@link
   *     cz.o2.proxima.direct.server.rpc.proto.service.Rpc.GetRequest}.
   * @return Instance of {@link cz.o2.proxima.direct.server.rpc.proto.service.Rpc.GetResponse}.
   */
  ...
  /**
   * Send synchronously {@link cz.o2.proxima.direct.server.rpc.proto.service.Rpc.ListRequest} to
   * retrieve attributes for entity.
   *
   * @param request Instance of {@link
   *     cz.o2.proxima.direct.server.rpc.proto.service.Rpc.ListRequest}.
   * @return Instance of {@link cz.o2.proxima.direct.server.rpc.proto.service.Rpc.ListResponse}.
   */
